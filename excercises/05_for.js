...
var frutas = ['pera','mandarina','manzana','banana','durazno'];
...
for (var i=0; i<= frutas.length - 1;i++){
    alert(frutas[i].substring(0,1).toUpperCase() + frutas[i].substring(1));
}
...
alert('The result of exercise 5-c is: ' + sentence);
...
console.log('The result of exercise 5 D is: ' + things);